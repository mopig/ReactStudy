var ProductCategoryRow = React.createClass({displayName: "ProductCategoryRow",
    render: function() {
        return (React.createElement("div", null, React.createElement("div", {className: "th td"}, this.props.category)));
    }
});
    ...
    render: function() {
        ...
        return (
            React.createElement("div", null, 
                React.createElement("div", {className: "td"}, name), 
                React.createElement("div", {className: "td"}, this.props.product.price)
            )
        );
    }
});
...
var ProductTable = React.createClass({displayName: "ProductTable",
    render: function() {
        ...
        return (
            React.createElement("div", null, 
                React.createElement("div", {className: "th td"}, "Name"), 
                React.createElement("div", {className: "th td"}, "Price"), 
